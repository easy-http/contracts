...
### Changed
- Renamed project from [layer-contracts](https://github.com/easy-http/layer-contracts) to [contracts](https://github.com/easy-http/layer-contracts) for improved clarity
